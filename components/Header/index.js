            ...
            >
              {!isBlog ? (
                <div className="grid grid-cols-1">
                  {showBlog && (
                    <Button onClick={() => router.push("/acceso_a_informacion")}>Acceso a la información</Button>
                  )}
                  {showResume && (
                    <Button
                      onClick={() =>
      ...
      >
        ...
        {!isBlog ? (
          <div className="flex">
            ...
            {showBlog && (
              <Button id="menu" onClick={() => router.push("/acceso_a_informacion")}>Acceso a la información</Button>
            )}
            {showResume && (
              <Button
                id="menu"
